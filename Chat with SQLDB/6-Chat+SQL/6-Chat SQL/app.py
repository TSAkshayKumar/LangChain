...
def configure_db(db_uri,mysql_host=None,mysql_user=None,mysql_password=None,mysql_db=None):
    if db_uri==LOCALDB:
        ...
        # The number of slashes (///) indicates:
            # 3 slashes (///) → SQLite database with a relative path (database file located in your project folder).
            # 4 slashes (////) → SQLite database with an absolute path (full path from the root directory).                           
